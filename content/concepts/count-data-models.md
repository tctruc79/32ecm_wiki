...
| `verylikely` (so với base "very unlikely") | 0.4376 | 1.5490 | Người cho rằng rủi ro nhiễm là "rất có khả năng" mua vaccine kỳ vọng **cao hơn 54.9%** so với người cho rằng "rất không có khả năng" (base), giữ các biến khác không đổi<br><span class="en">A person who perceives the risk of infection as "very likely" has an expected vaccine purchase **54.9% higher** than someone who perceives it as "very unlikely" (base), holding other variables fixed</span> |
